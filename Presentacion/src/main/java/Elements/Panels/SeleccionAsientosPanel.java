...
public class SeleccionAsientosPanel extends JPanel {
    ...
    private JPanel construirMatrizAsientos() {
        ...
        contenedorCentral.setBackground(Elements.Utileria.UtilGeneral.FONDO_PRINCIPAL);
        ...
        matriz.setBackground(Elements.Utileria.UtilGeneral.FONDO_PRINCIPAL);
    ...
    private JPanel construirPiePagina() {
        ...
        pie.setBackground(Elements.Utileria.UtilGeneral.FONDO_ENCABEZADO);
