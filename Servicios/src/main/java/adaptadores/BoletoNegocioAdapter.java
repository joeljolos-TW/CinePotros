...
/**
 * Adapter de negocio encargado de convertir entidades de MongoDB
 * a DTOs para la capa de presentación.
 * @author Jazmin
 */
public class BoletoNegocioAdapter {
    /**
     * Convierte una entidad de boleto junto con su función y película
     * a un BoletoDTO para mostrar en pantalla.
     *
